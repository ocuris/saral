...
* सहायता: [support@example.com](mailto:support@example.com)
...
अगर आप चाहें तो मैं इसे और **संक्षिप्त और beginner-friendly version** बना दूँ जिसमें सिर्फ **install, uv sync और notebook run** steps हों, ताकि कोई भी student 2-3 commands में start कर सके।
